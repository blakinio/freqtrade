...
from ai_platform.scripts.residual_pytorch_bounded_m1_v3_generalization import (
...
class ResidualPyTorchM1V3DataAuditRegressor(BaseRegressionModel):
    """Audit the exact SOL/XRP v3 expanded matrices before comparator fitting."""
    ...
    def fit(
        ...
        **kwargs: Any,
        ...
        if output.exists():
            raise ValueError(f"Duplicate bounded M1 v3 audit path: {output}")
