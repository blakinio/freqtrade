...
def _ranking_key(
    ...
    trade_count = -1 if metric is None or metric.trade_count_24h is None else metric.trade_count_24h
    spread = (
        Decimal("Infinity") if metric is None or metric.spread_bps is None else metric.spread_bps
    )
