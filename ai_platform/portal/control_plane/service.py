        ...
        try:
            with self._session_factory() as session, session.begin():
                ...
                generation = RuntimeGeneration(
                    ...
                    isolation_plan_digest=material.isolation_plan_digest,
                    gateway_artifact_digest=material.gateway_artifact_digest,
                    gateway_contract_version=material.gateway_contract_version,
                    gateway_contract_digest=material.gateway_contract_digest,
                    market_data_egress_policy_version=material.market_data_egress_policy_version,
                    market_data_egress_policy_digest=material.market_data_egress_policy_digest,
