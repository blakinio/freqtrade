...
class TradeOutcomeRow(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ("tenant_id", "bot_id"),
            ("portal_bots.tenant_id", "portal_bots.bot_id"),
            name="fk_portal_trade_outcome_bot",
            ondelete="RESTRICT",
        ),
...
class TradeAnalysisRow(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ("portal_decision_snapshots.tenant_id", "portal_decision_snapshots.snapshot_id"),
            name="fk_portal_trade_analysis_snapshot",
            ondelete="RESTRICT",
        ),
        ForeignKeyConstraint(
            ("tenant_id", "outcome_id"),
            ("portal_trade_outcomes.tenant_id", "portal_trade_outcomes.outcome_id"),
            name="fk_portal_trade_analysis_outcome",
            ondelete="RESTRICT",
        ),
