...
def _bounded_public_message(reason_code: str) -> str:
    messages = {
        "SIGNAL_WIZARD_CONTEXT_MISMATCH": "The command identity does not match the authenticated session.",
        "SIGNAL_WIZARD_ACTOR_TYPE_MISMATCH": "The command actor type does not match the authenticated session.",
        "SIGNAL_WIZARD_CORRELATION_MISMATCH": "The command correlation context is invalid.",
        "SIGNAL_WIZARD_PRODUCTION_FORBIDDEN": "Signal Wizard is unavailable in the production environment.",
        "SIGNAL_WIZARD_NO_ENABLED_FEATURES": "Enable at least one approved feature.",
        "FEATURE_REGISTRY_UNKNOWN_FEATURE": "A selected Feature Registry identity is unknown.",
        "FEATURE_NOT_APPROVED_FOR_AI": "A selected feature is not approved for AI research.",
        "FEATURE_DEPENDENCY_MISSING": "An enabled feature dependency must be explicitly selected and enabled.",
        "DSL_SCHEMA_INVALID": "The typed condition definition is invalid.",
        "PARAMETER_CONSTRAINT_UNKNOWN": "A parameter constraint references an unavailable enabled parameter.",
        "PARAMETER_CONSTRAINT_TYPE_INVALID": "A numeric constraint requires a numeric parameter value.",
        "FEATURE_PARAMETER_UNKNOWN": "A selected feature contains an unknown parameter.",
        "FEATURE_PARAMETER_TYPE_INVALID": "A selected feature parameter has an invalid type.",
        "FEATURE_PARAMETER_BELOW_MINIMUM": "A selected feature parameter is below the registry minimum.",
        "FEATURE_PARAMETER_ABOVE_MAXIMUM": "A selected feature parameter exceeds the registry maximum.",
        "FEATURE_PARAMETER_CHOICE_INVALID": "A selected feature parameter is outside the registry choices.",
        ...
        "FEATURE_NOT_DECLARED": "The typed condition references a feature that is not enabled.",
