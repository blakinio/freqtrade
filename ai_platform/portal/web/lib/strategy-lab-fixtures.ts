...
export const fixtureStrategies: StrategyLabDefinition[] = [
  ...
  },
  {
    ...
    parameters: [
      { name: "bb_length", kind: "integer", default: 20, minimum: "2", maximum: "100", choices: [] },
      { name: "bb_mult", kind: "number", default: 2, minimum: "0.5", maximum: "5", choices: [] },
      { name: "kc_length", kind: "integer", default: 20, minimum: "2", maximum: "100", choices: [] },
      { name: "kc_mult", kind: "number", default: 1.5, minimum: "0.5", maximum: "5", choices: [] },
