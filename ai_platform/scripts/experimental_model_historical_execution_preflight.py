...
EXPECTED_PREDICTION_TIMERANGE = "20260301-20260630"
...
def _canonical_inputs() -> tuple[dict[str, Any], list[dict[str, Any]]]:  # noqa: C901
    ...
    if foundation["shared_temporal_geometry"]["historical_oos_window"] != EXPECTED_HISTORICAL_OOS:
        raise ExperimentalHistoricalPreflightError("Historical OOS window drifted")
