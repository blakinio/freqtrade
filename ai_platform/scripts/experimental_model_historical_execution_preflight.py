...
EXPECTED_DOWNLOAD_WINDOW = "20250801-20260630"
EXPECTED_DOWNLOAD_TIMERANGE = "20250801-20260701"
EXPECTED_PREDICTION_WINDOW = "20260301-20260630"
EXPECTED_PREDICTION_TIMERANGE = "20260301-20260701"
...
def _canonical_inputs() -> tuple[dict[str, Any], list[dict[str, Any]]]:  # noqa: C901
    ...
    expected_geometry = {
        ...
        "prediction_window": EXPECTED_PREDICTION_WINDOW,
        "download_window": EXPECTED_DOWNLOAD_WINDOW,
...
def build_preflight_report(*, freqtrade_bin: str = "freqtrade") -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "preflight_id": "experimental-model-historical-execution-preflight-v1",
...
def verify_downloaded_data(datadir: Path) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.mode == "verify-data":
            result = verify_downloaded_data(args.datadir.resolve())
        else:
