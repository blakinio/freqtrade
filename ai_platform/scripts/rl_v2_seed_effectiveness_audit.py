...
MATERIALIZER_PATH = Path("ai_platform/scripts/rl_v2_action_observability_execution_run_request.py")
...
WORKFLOW_PATH = Path(".github/workflows/ai-platform-rl-v2-action-observability-execution.yml")
REQUEST_PATH = Path(
