...
self = Index(['bb_upper', 'bb_lower', 'kc_upper', 'kc_lower', 'squeeze_on',
       'squeeze_off', 'no_squeeze', 'squeeze_ratio', 'linreg_momentum',
       'momentum_slope', 'momentum_acceleration', 'squeeze_release'],
      dtype='str')
key = 'squeeze_state'
...
ai_platform/research/strategy_engine/ase00_adapter.py:388: in _features
    value = _row_mapping(
ai_platform/research/strategy_engine/ase00_adapter.py:799: in _row_mapping
...
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_complete_synthetic_shadow_flow_uses_existing_risk_core - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_duplicate_event_is_idempotent - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_delayed_event_is_accepted_when_available_before_decision - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_out_of_order_event_input_is_normalized - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_future_feature_is_rejected_fail_closed - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_unconfirmed_pivot_is_rejected - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_existing_risk_core_rejection_is_preserved - KeyError: 'squeeze_state'
FAILED tests/ai_platform_integration/test_ase00_vertical_slice.py::test_restart_and_replay_produces_identical_evidence - KeyError: 'squeeze_state'
=================== 8 failed, 4 passed, 2 warnings in 3.38s ====================
