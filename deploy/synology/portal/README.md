...
- bind: `192.168.1.2:3030`;
- browser URL: `http://synology:3030` or `http://192.168.1.2:3030`;
...
The final container is accepted only after its Docker health check passes and the runner can reach `http://192.168.1.2:3030/`. A failed final health check automatically attempts to restore the previous image.
