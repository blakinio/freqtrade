...
status: active
branch: test/portal-p12-seeded-close-time-repair-clean-20260723
base_branch: develop
created: 2026-07-23
updated: 2026-07-23
related_pr: null
...
Because P12 foundation PR #216 was squash-merged, retargeting the provenance branch would reintroduce foundation history into the final diff. The final acceptance branch therefore replays only the two durable outputs on current `develop`: this evidence record and the regression test. PR #217 remains provenance for the seed/failure/repair commit history and must not be merged.
...
updated_at: 2026-07-23T18:20:00+02:00
head: 26c9c9e2ec41797c9fdc180cad7f89a7ad5f6b7c
branch: test/portal-p12-seeded-close-time-repair-clean-20260723
pr: pending
status: validating
context_routes:
...
proven:
  ...
  - Final diff on this clean branch contains no simulator product-code modification; only durable regression and evidence remain.
derived:
  ...
  - PR #217 is evidence provenance, while this clean branch is the only merge candidate for durable acceptance artifacts.
unknown: []
conflicts: []
first_failure:
...
blockers: []
next_action: Open the clean final acceptance PR against develop, validate required CI, merge only the durable regression/evidence outputs, then close provenance PR #217 unmerged.
```
