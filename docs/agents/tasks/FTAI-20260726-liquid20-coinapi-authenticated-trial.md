...
blockers: []
next_action: Remove the temporary authenticated workflow and script, validate the durable evidence on the exact final head, and merge PR 352 if CI and review are clean.
```
