...
status: validating
branch: fix/freqtrade-synology-runner-cutover-preflight-20260727
base_branch: develop
created: 2026-07-27
updated: 2026-07-27
owned_paths:
...
updated_at: 2026-07-27T19:05:00+02:00
head: a6a70f582eb9b97809dde8bc309c5958c9deed26
branch: fix/freqtrade-synology-runner-cutover-preflight-20260727
pr: null
status: validating
context_routes:
...
next_action: Open and validate the preflight PR, merge it, then read all four Synology status contexts before planning the self-replacing cutover.
```
