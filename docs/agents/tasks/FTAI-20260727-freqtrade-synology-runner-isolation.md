...
updated_at: 2026-07-27T16:42:00+02:00
head: 365593af0707e29c4b5908645290dc18cbb2b24e
branch: feat/freqtrade-synology-runner-isolation-20260727
pr: "#485 open"
status: validating
context_routes:
...
proven:
  ...
  - PR 485 contains the dedicated Freqtrade runner package and PI-06 state-contract migration without Synology mutation.
derived:
...
unknown:
  - Exact-head CI and security-analysis result for PR 485.
...
changed_paths:
  ...
  - docs/agents/tasks/FTAI-20260727-freqtrade-synology-runner-isolation.md
validation:
  - command: PR 485 exact-head Freqtrade CI, runner-image build and security analysis
    result: NOT_RUN
    evidence: Workflows were triggered after PR creation and are pending.
  - command: owner-managed Synology runner replacement and PI-06 preflight
    result: NOT_RUN
    evidence: Forbidden before PR 485 is reviewed and merged.
blockers:
...
next_action: Observe PR 485 exact-head CI, runner-image build and security analysis; repair only the first concrete failure and do not mutate Synology before merge.
```
