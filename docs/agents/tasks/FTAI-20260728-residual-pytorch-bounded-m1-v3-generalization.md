...
updated_at: 2026-07-28T20:22:00+02:00
head: c054f91318158fb33a2a9fbfd2ad352fbcb9bdf9
branch: fix/residual-pytorch-m1-v3-lightgbm-evidence-20260728
pr: 648
status: validating
context_routes:
...
proven:
  ...
  - Request PR 629 triggered guarded run 30360316606 and is closed without merge.
...
derived:
  ...
  - V3-specific evidence validation can remain fail-closed while selecting the required evidence shape from frozen model identity.
unknown:
  - Whether PR 648 passes exact-head CI.
...
validation:
  ...
  - command: PR 648 exact-head CI
    result: RUNNING
    evidence: Standard repository validation is executing on the remediation head.
blockers: []
next_action: Complete exact-head CI and merge PR 648; then reset the request branch to the remediation merge SHA and generate a fresh exact-one-file v3 request.
```
