...
- the temporary repair workflow removed itself; the final diff again contains only the implementation, focused test and this task record;
...
updated_at: 2026-08-01T09:13:00+02:00
head: checkpoint commit with parent 754ca47820bf5734ab3fc0e40bc65e4db28be497
...
proven:
  ...
  - repair head 754ca47820bf5734ab3fc0e40bc65e4db28be497 changes exactly the three owned paths and contains no temporary workflow
derived:
...
unknown:
  - exact-head CI results for the repair checkpoint head
  - whether the repaired trusted-runner materialization produces non-empty partitions from the frozen real inputs
conflicts: []
first_failure:
  marker: Liquid20 import lacks required pre-roll
  evidence: workflow 30688887667 job 91339968858 after independent source verification and before any output publication
rejected_hypotheses:
...
validation:
  ...
  - command: compare develop...fix/wickhunter-wh01-liquid20-preroll-20260801
    result: PASS
    evidence: behind_by=0 and exactly three owned files; temporary workflow absent
blockers: []
