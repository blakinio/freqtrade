...
- PR `#1394` now keeps diagnostics inside the already-registered WH09 deployment workflow rather than adding a separate workflow. A merge containing diagnostic request v4 skips the deploy job and runs only the diagnostic job.
- Diagnostic request v4 is immutable and binds inspection to the exact failed run/job, exact original container ID and exact image ID. The diagnostic job contains no container start/stop/restart/recreate/remove/kill path and uploads evidence even if runtime inspection fails after evidence creation.
- Prior review P2 `Bind inspection to the deployed image and container` is addressed by exact container/image binding.
- Exact diagnostic workflow/request/test code head is `2df984fa925e55fe697d12d40b47cc87d03f5e50`. This checkpoint commit is documentation-only.

## Context checkpoint

```yaml
checkpoint_version: 1
updated_at: 2026-08-08T22:18:00+02:00
branch: diagnose/wickhunter-wh09-runtime-health-20260808
pr: 1394
status: validating
phase: diagnose
...
last_progress_at: 2026-08-08T22:18:00+02:00
...
diagnostic:
  pr: 1394
  exact_code_head: 2df984fa925e55fe697d12d40b47cc87d03f5e50
...
recovery:
  ...
  checkpointed_at: 2026-08-08T22:18:00+02:00
  last_progress_at: 2026-08-08T22:18:00+02:00
  phase: diagnose
  exact_head: 2df984fa925e55fe697d12d40b47cc87d03f5e50
  ...
  external_run_ids:
    - 31275253098
    - 93147659559
  operation_started_at: 2026-08-08T22:15:00+02:00
  wait_deadline_at: 2026-08-08T23:00:00+02:00
