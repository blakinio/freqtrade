...
as_of_sha: 4473dfc166d83fe5e0ffba4045c0dcd967626d68
generated_at: 2026-08-06T12:26:00Z
open_audit_issues: 46
...
| `P6` | Portal web shell and core operations UI | `PARTIAL` | `COMPLETE` | `PARTIAL` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1085, #1087, #1089, #1090, #1095, #1096, #1097, #1098, #1102, #1103, #1104, #1114, #1116, #1117, #1118, #1119, #1121, #1123, #1140 |
...
| `SURFACE-POSITIONS` | Open Positions | `/positions` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1092, #1098, #1107, #1119, #1123 |
...
| `SURFACE-TERMINAL` | Trading Terminal | `/terminal` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1086, #1089, #1098, #1108, #1109, #1110, #1113, #1114, #1120 |
| `SURFACE-ORDERS` | Orders | `/orders` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1092, #1098, #1107, #1119, #1123 |
| `SURFACE-TRADES` | Trade History | `/trades` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1092, #1098, #1107, #1119, #1123 |
...
| `SURFACE-CREATE-BOT` | Create Bot | `/bots/new` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1090, #1098, #1113 |
| `SURFACE-SIGNALS` | Signal Wizard | `/bots/signals` | `DISCONNECTED` | `PARTIAL` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1095, #1098, #1113 |
| `SURFACE-STRATEGY-CATALOG` | Strategy Catalog | `/bots/strategies` | `DISCONNECTED` | `PARTIAL` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1085, #1089, #1098, #1109 |
| `SURFACE-GRID` | Grid Bots | `/bots/grid` | `DISCONNECTED` | `PARTIAL` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1096, #1098, #1113 |
| `SURFACE-AI-OVERVIEW` | AI Overview | `/ai` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1102, #1107, #1119, #1123 |
| `SURFACE-TRADE-ANALYSIS` | Trade Analysis | `/ai/trade-analysis` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1102, #1107, #1119 |
| `SURFACE-INSIGHTS` | Insights | `/ai/insights` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1102, #1107, #1119 |
| `SURFACE-MODEL-HEALTH` | Model Health | `/ai/model-health` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1102, #1107, #1119, #1136 |
...
| `SURFACE-LEARNING` | Learning History | `/ai/learning` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1102, #1107, #1119 |
| `SURFACE-EXECUTION-LOGS` | Execution Logs | `/operations/execution-logs` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1094, #1098, #1107, #1108, #1119, #1123 |
...
| `SURFACE-RUNTIME-HEALTH` | Runtime Health | `/operations/runtime-health` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1092, #1098, #1099, #1119, #1136 |
| `SURFACE-AUDIT` | Audit Events | `/operations/audit` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1098, #1107, #1108, #1111 |
| `SURFACE-EXCHANGES` | Exchange Connections | `/platform/exchanges` | `DISCONNECTED` | `PARTIAL` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1097, #1098, #1100, #1113 |
| `SURFACE-NOTIFICATIONS` | Notifications | `/platform/notifications` | `PARTIAL` | `PARTIAL` | `PARTIAL` | `FIXTURE_ONLY` | `PARTIAL` | `BLOCKED` | #1089, #1098, #1104, #1107, #1112, #1123 |
...
| `SURFACE-BOT-DETAIL` | Bot Detail | `/bots/detail/[botId]` | `DISCONNECTED` | `COMPLETE` | `DISCONNECTED` | `FIXTURE_ONLY` | `PARTIAL` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1089, #1091, #1092, #1093, #1098, #1099, #1119, #1123 |

## Cross-cutting control records

| ID | Name | Overall | Repository | Runtime | API E2E | Deployment | Protected target | Open Issues |
|---|---|---|---|---|---|---|---|---|
| `CONTROL-STATUS-AUTHORITY` | Canonical completeness status authority | `PARTIAL` | `PARTIAL` | `NOT_APPLICABLE` | `NOT_APPLICABLE` | `NOT_APPLICABLE` | `NOT_APPLICABLE` | #1101 |
...
| `CONTROL-SUPPLY-CHAIN-DR` | Deployment supply chain and disaster recovery | `MISSING` | `MISSING` | `NOT_APPLICABLE` | `NOT_APPLICABLE` | `MISSING` | `EXTERNAL_ACCEPTANCE_REQUIRED` | #1116, #1139 |
...
The following Issues are open at snapshot `4473dfc166d83fe5e0ffba4045c0dcd967626d68` and every one is linked to at least one
non-complete dimension in the JSON ledger:

#1085, #1086, #1087, #1089, #1090, #1091, #1092, #1093, #1094, #1095, #1096, #1097, #1098, #1099, #1100, #1101, #1102, #1103, #1104, #1107, #1108, #1109, #1110, #1111, #1112, #1113, #1114, #1115, #1116, #1117, #1118, #1119, #1120, #1121, #1123, #1128, #1129, #1130, #1132, #1134, #1135, #1136, #1137, #1139, #1140, #1142
