...
WORKFLOW_PATH = REPOSITORY_ROOT / ".github/workflows/liquidations-live-portal-synology-proof.yml"
SOURCE_PATH = REPOSITORY_ROOT / "deploy/synology/portal/prove-liquidations-live.sh"
WRAPPER_PATH = REPOSITORY_ROOT / "deploy/synology/portal/run-liquidations-live-portal-proof.sh"
...
def test_failure_evidence_remains_fail_closed() -> None:
    ...
    assert "See the paired workflow log for the exact ERR trap line and command." in wrapper
...
def test_workflow_executes_and_retriggers_on_the_wrapper() -> None:
    ...
    assert "PORTAL_LIQUIDATIONS_HOST_ROOT: /volume1/docker/freqtrade-liquidations/data" in workflow
