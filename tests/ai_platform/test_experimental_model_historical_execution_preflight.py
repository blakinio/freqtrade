...
def test_historical_execution_preflight_builds_only_guarded_command_paths() -> None:
    ...
    assert report["download_window"] == "20250801-20260630"
    assert report["download_timerange"] == "20250801-20260701"
    assert report["prediction_window"] == "20260301-20260630"
    assert report["prediction_timerange"] == "20260301-20260701"
    ...
    assert "20250801-20260701" in download_command
    ...
    for command in backtests.values():
        ...
        assert "20260301-20260701" in command
