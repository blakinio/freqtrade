...
def test_v4_request_is_zero_authority() -> None:
    ...
    for key in ("portal_deploy_authorized", "wh09_redeploy_authorized", "paper_activation_authorized", "trading_credentials_present", "order_adapter_present", "execution_enabled", "live_capital_authorized"):
